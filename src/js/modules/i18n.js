const translations = {
    pt: {
        ...
        fire: "FIRE",
        salary: "Salário",
        monthly_spend: "Gasto Mensal Desejado",
        current_wealth: "Patrimônio Atual",
        monthly_invest: "Aporte Mensal",
        real_return: "Rentabilidade Real Anual (%)",
        fire_target_amount: "Montante Alvo",
        time_to_fire: "Tempo Restante",
        contract_type: "Tipo de Contrato",
        gross_salary: "Salário Bruto",
        pj_revenue: "Faturamento Mensal",
        net_salary: "Líquido Real",
        total_discounts: "Total Descontos",
        years_label: "anos",
        months_label: "meses",
        inflation: "Inflação",
        prepayment: "Antecipação",
        original_amount: "Valor Original",
        annual_inflation: "Inflação Anual Média (%)",
        period_years: "Período (Anos)",
        purchasing_power: "Poder de Compra",
        adjusted_value: "Valor Corrigido",
        power_loss: "Perda de Poder",
        current_balance: "Saldo Devedor Atual",
        monthly_rate: "Taxa Mensal (%)",
        extra_payment: "Aporte Extra",
        prepayment_summary: "Resumo da Antecipação",
        interest_saved: "Juros Economizados",
        months_reduced: "Meses Reduzidos",
        simulate_ir: "Simular Imposto de Renda (Regressivo)",
        compare_sac_price: "Comparar SAC vs PRICE no gráfico"
    },
    en: {
        ...
        fire: "FIRE",
        salary: "Salary",
        monthly_spend: "Desired Monthly Spending",
        current_wealth: "Current Wealth",
        monthly_invest: "Monthly Contribution",
        real_return: "Annual Real Return (%)",
        fire_target_amount: "Target Amount",
        time_to_fire: "Time Remaining",
        contract_type: "Contract Type",
        gross_salary: "Gross Salary",
        pj_revenue: "Monthly Revenue",
        ...
        prepayment_summary: "Prepayment Summary",
        interest_saved: "Interest Saved",
        months_reduced: "Months Reduced",
        simulate_ir: "Simulate Income Tax (Regressive)",
        compare_sac_price: "Compare SAC vs PRICE on chart"
    },
    es: {
        ...
        footer_proof: "Prueba de conceito por IA",
        length: "📏 Longitud",
        mass: "⚖️ Masa",
        temperature: "🌡️ Temperatura",
        area: "📐 Área",
        ...
        fire: "FIRE",
        salary: "Salario",
        monthly_spend: "Gasto Mensual Deseado",
        current_wealth: "Patrimonio Actual",
        monthly_invest: "Aporte Mensual",
        real_return: "Rentabilidade Real Anual (%)",
        fire_target_amount: "Monto Objetivo",
        time_to_fire: "Tiempo Restante",
        contract_type: "Tipo de Contrato",
        gross_salary: "Salario Bruto",
        pj_revenue: "Facturación Mensual",
        net_salary: "Neto Real",
        total_discounts: "Total Descuentos",
        years_label: "años",
        months_label: "meses",
        inflation: "Inflação",
        prepayment: "Amortización",
        original_amount: "Monto Original",
        annual_inflation: "Inflación Anual (%)",
        period_years: "Periodo (Años)",
        purchasing_power: "Poder de Compra",
        adjusted_value: "Monto Corregido",
        power_loss: "Pérdida de Poder",
        current_balance: "Saldo Deudo Atual",
        monthly_rate: "Tasa Mensual (%)",
        extra_payment: "Aporte Extra",
        prepayment_summary: "Resumen de Amortización",
        interest_saved: "Interés Ahorrado",
        months_reduced: "Meses Reducidos",
        simulate_ir: "Simular Impuesto (IR)",
        compare_sac_price: "Comparar SAC vs PRICE"
    }
};
